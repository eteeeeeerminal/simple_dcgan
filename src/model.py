...
if __name__ == '__main__':
    ...
    traced_netG = torch.jit.trace(netG, torch.rand([4,100, 1, 1]))
    traced_netG.save("model/generator.pt")
    traced_netD = torch.jit.trace(netD, torch.rand([4,3,64,64]))
    traced_netD.save("model/discriminator.pt")